		...
		<el-card class="box-card" style="margin-bottom:10px;">
							...
							<div style="padding: 10px;">
								...
								<div style="font-size:11px;" class="bottom clearfix">
									<time style="font-size:11px;color:red" class="time"><span
											style="font-size:13px;color:#000">{{item.discount_price}}¥ </span> <span
											style="text-decoration:line-through;color:#ccc">{{item.product_price}}¥</span></time>
									<div>
			...
			<div style="text-align:center">
				<el-pagination background @current-change="handleCurrentChange" layout="prev, pager, next"
					:page-size="search.pageIndex" :total="search.count">
				</el-pagination>
			</div>
		</el-card>
	</div>
